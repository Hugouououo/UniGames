...
/** @type {string} */
const CACHE_VERSION = '1778443477|5905136711';
/** @type {string} */
const CACHE_PREFIX = 'UniGames-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'UniGames.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["UniGames.html","UniGames.js","UniGames.offline.html","UniGames.icon.png","UniGames.apple-touch-icon.png","UniGames.audio.worklet.js","UniGames.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["UniGames.wasm","UniGames.pck","UniGames.side.wasm"];
